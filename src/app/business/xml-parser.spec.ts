...
describe('XmlParser', () => {
  ...
  it('should parse list of betriebspunkte', () => {
    ...
    let actual = testee.parseExport(xml);

    expect(actual.betriebspunkById).toHaveSize(2);
    expect(actual.betriebspunkById.get('4086')).toEqual(new Betriebspunkt('Davos Platz', 'DAV'));
    expect(actual.betriebspunkById.get('4087')).toEqual(new Betriebspunkt('Davos Dorf', 'DAD'));
  });
  ...
  it('should parse single betriebspunkt', () => {
    ...
    expect(actual.betriebspunkById).toHaveSize(1);
    expect(actual.betriebspunkById.get('4087')).toEqual(new Betriebspunkt('Davos Dorf', 'DAD'));
  });
  ...
  it('should parse list of tagesleistungen', () => {
    ...
    expect(actual.tagesLeistungen).toHaveSize(2);
    ...
    expect(actual.tagesLeistungen[0]).toEqual(expectedTl0);
    expect(actual.tagesLeistungen[1]).toEqual(expectedTl1);
  });
  ...
  it('should parse follow train number and id', () => {
    ...
    expect(actual.tagesLeistungen[0]).toEqual(expectedTl0);
    expect(actual.tagesLeistungen[0].zuege[0].hasFolgezug()).toBeTrue();
    expect(actual.tagesLeistungen[1]).toEqual(expectedTl1);
    expect(actual.tagesLeistungen[1].zuege[0].hasFolgezug()).toBeFalse();
  });
  ...
  it('should parse list of streckenabschnitte', () => {
    ...
    expect(actual.streckenabschnitteById).toHaveSize(2);
    expect(actual.streckenabschnitteById.get('4088')).toEqual(new StreckenAbschnitt('2669'));
    expect(actual.streckenabschnitteById.get('4161')).toEqual(new StreckenAbschnitt('3635'));
  });
  ...
  it('should parse list of bildvarianten', () => {
    ...
    expect(actual.meldungVarianteById).toHaveSize(2);
    expect(actual.meldungVarianteById.get('4902')).toEqual(new MeldungVariante(VariantenType.BildMeldung, 'image//svg', 'TFT_RhB10.svg', ''));
    expect(actual.meldungVarianteById.get('4943')).toEqual(new MeldungVariante(VariantenType.BildMeldung, 'image//svg', 'TFT_Bus_AS_titel.svg', ''));
  });
  ...
  it('should parse list of audiovarianten', () => {
    ...
    expect(actual.meldungVarianteById).toHaveSize(2);
    expect(actual.meldungVarianteById.get('34830')).toEqual(new MeldungVariante(VariantenType.AudioMeldung, 'audio/mpeg3', 'D_BE_AGZ2.mp3', ''));
    expect(actual.meldungVarianteById.get('34835')).toEqual(new MeldungVariante(VariantenType.AudioMeldung, 'audio/mpeg3', 'D_F072_1x.mp3', ''));
  });
  ...
  it('should parse list of textvarianten', () => {
    ...
    expect(actual.meldungVarianteById).toHaveSize(2);
    expect(actual.meldungVarianteById.get('4904')).toEqual(new MeldungVariante(VariantenType.TextMeldung, '', '', 'Landquart'));
    expect(actual.meldungVarianteById.get('4906')).toEqual(new MeldungVariante(VariantenType.TextMeldung, '', '', 'Abfahrt um: 12:00'));
  });
  ...
  it('should parse list of sprachen', () => {
    ...
    expect(actual.spracheById).toHaveSize(2);
    expect(actual.spracheById.get('0')).toEqual(new Sprache('de', 'Deutsch'));
    expect(actual.spracheById.get('4884')).toEqual(new Sprache('en', 'Englisch'));
  });
  ...
  it('should parse list of meldungen with audiomeldungen', () => {
    ...
    expect(actual.meldungenById).toHaveSize(2);
    expect(actual.meldungenById.get('1')).toEqual(
      new Meldung([meldungVariante1, meldungVariante2], 'Landquart', 'ela.Innen', '36', SprachProvider.german()));
    expect(actual.meldungenById.get('2')).toEqual(
