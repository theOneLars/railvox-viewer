...
describe('Verkehrsperiode', () => {
  ...
  it('should parse days', () => {
    ...
    expect(testee.fromDate).toEqual(new Date(2021, 12, 12));
    expect(testee.toDate).toEqual(new Date(2022, 12, 10));
  });
  ...
  it('should convert bitmask number of days', () => {
    ...
    console.log('bitmask', testee.getBinaryBitmask());
  });
  ...
  it('should detect date out of range', () => {
    ...
    expect(testee.isValidOnDay(new Date(2021, 12, 11))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2022, 12, 11))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2022, 12, 10))).toBeTrue();
    expect(testee.isValidOnDay(new Date(2021, 12, 12))).toBeTrue();
    expect(testee.isValidOnDay(new Date(2022, 1, 1))).toBeTrue();
  });

  it('should detect of valid for day with 4 binary digits ', () => {
    let testee = new Verkehrsperiode('1', 'test', '2021-12-14', '2021-12-17', '0');
    expect(testee.isValidOnDay(new Date(2021, 12, 14))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 15))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 16))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 17))).toBeFalse();

    testee = new Verkehrsperiode('1', 'test', '2021-12-14', '2021-12-17', '1');
    expect(testee.isValidOnDay(new Date(2021, 12, 14))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 15))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 16))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 17))).toBeTrue();

    testee = new Verkehrsperiode('1', 'test', '2021-12-14', '2021-12-17', '4');
    expect(testee.isValidOnDay(new Date(2021, 12, 14))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 15))).toBeTrue();
    expect(testee.isValidOnDay(new Date(2021, 12, 16))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 17))).toBeFalse();

    testee = new Verkehrsperiode('1', 'test', '2021-12-14', '2021-12-17', '8');
    expect(testee.isValidOnDay(new Date(2021, 12, 14))).toBeTrue();
    expect(testee.isValidOnDay(new Date(2021, 12, 15))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 16))).toBeFalse();
    expect(testee.isValidOnDay(new Date(2021, 12, 17))).toBeFalse();
  });
  ...
  it('should detect of valid for day with 16 binary digits ', () => {
    ...
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-5', '80').isValidOnDay(new Date(2021, 12, 1))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-5', '40').isValidOnDay(new Date(2021, 12, 2))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-5', '20').isValidOnDay(new Date(2021, 12, 3))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-5', '10').isValidOnDay(new Date(2021, 12, 4))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-5', '01').isValidOnDay(new Date(2021, 12, 5))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-6', '01').isValidOnDay(new Date(2021, 12, 6))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-7', '01').isValidOnDay(new Date(2021, 12, 7))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-8', '01').isValidOnDay(new Date(2021, 12, 8))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-9', '001').isValidOnDay(new Date(2021, 12, 9))).toBeTrue();
    expect(new Verkehrsperiode('1', 'test', '2021-12-1', '2021-12-9', '800').isValidOnDay(new Date(2021, 12, 1))).toBeTrue();
